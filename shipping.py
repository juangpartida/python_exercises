# Purpose of this project is to build a functioning program that will take weight of a package and then determine the most affordable shipping option package. 

# math notes which will be used within the program 
